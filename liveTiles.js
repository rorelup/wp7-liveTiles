Cordova.addConstructor(function () {
    ...
    navigator.plugins.liveTiles =
    {
        updateAppTile: function (successCallback, errorCallback, options) {
            ...
            Cordova.exec(successCallback, errorCallback, "LiveTiles", "updateAppTile", options);
        },
        ...
        createSecondaryTile: function (successCallback, errorCallback, options) {
            ...
            Cordova.exec(successCallback, errorCallback, "LiveTiles", "createSecondaryTile", options);
        },
        updateSecondaryTile: function (successCallback, errorCallback, options) {
            ...
            Cordova.exec(successCallback, errorCallback, "LiveTiles", "updateSecondaryTile", options);
        },
        deleteSecondaryTile: function (successCallback, errorCallback, options) {
            ...
            Cordova.exec(successCallback, errorCallback, "LiveTiles", "deleteSecondaryTile", options);
        }
    }
});